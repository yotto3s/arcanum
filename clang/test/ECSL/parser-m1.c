...
// logical connectives, negation, \result, and multi-clause contracts all survive
// the full pipeline (-fecsl, -fsyntax-only) without triggering an assertion,
// crash, or unexpected diagnostic.
